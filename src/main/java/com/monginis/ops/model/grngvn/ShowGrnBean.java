...
public class ShowGrnBean {
	...
	public String toString() {
		return "ShowGrnBean [billDetailNo=" + billDetailNo + ", itemId=" + itemId + ", frId=" + frId + ", itemName="
				...
				+ ", billQty=" + billQty + ", billDate=" + billDate + ", sgstPer=" + sgstPer + ", cgstPer=" + cgstPer
				+ ", igstPer=" + igstPer + ", calcBaseRate=" + calcBaseRate + ", menuId=" + menuId + ", catId=" + catId
				+ ", invoiceNo=" + invoiceNo + ", autoGrnQty=" + autoGrnQty + ", taxPer=" + taxPer + ", grnAmt="
				+ grnAmt + ", billDateTime=" + billDateTime + ", taxableAmt=" + taxableAmt + ", grnRate=" + grnRate
				+ ", taxAmt=" + taxAmt + "]";
	}
