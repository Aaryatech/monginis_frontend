...
<div class="row">
	...
	<div class="colOuter">
		...
		<input id="fromdatepicker"  placeholder="Delivery Date"  name="from_Date" autocomplete="off" type="text" size="35" >
		</div></div>
		<div class="col2"><div class="col1title"><b>TO&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>
		<input id="todatepicker"  placeholder="Delivery Date"  name="to_Date" autocomplete="off" type="text" size="35" >
		</div></div>
