	...
	<div class="content mCustomScrollbar">
		<ul>
			...
			<c:if test="${info.accessRight==1 or info.accessRight==2}">
				...
				<li><a
					href="${pageContext.request.contextPath}/showDashboardFranchisee"><div
							class="img">
							<img
								src="${pageContext.request.contextPath}/resources/images//nav-orerhistory.png"
								alt="img">
					...
					<li class="small-box">
						...
						<div class="ibox">
							...
							<a href="${pageContext.request.contextPath}/showSpAdvanceReport"><i
								...
								href="${pageContext.request.contextPath}/showRegCakeAsSpOrRep"><i
								class="fa fa-files-o icon"></i>Regular Cake As Special Order
								Report</a>
