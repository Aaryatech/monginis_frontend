...
<div class="left">
	...
	<div class="fullform">
		...
		<div class="cackrighttexbox">${albumCode}</div>
	</div>
	...
	<div class="fullform">
		<div class="cackimg">
	<img src="${url_album}${spImage}" onerror="this.src='${pageContext.request.contextPath}/resources/images/No_Image_Available.jpg';"></div>
...
<!--formBox-->
	...
	<a href="${pageContext.request.contextPath}/showSpCakeCatOrder/${globalIndex}"><h1><< Back</h1></a>
<br/>    
	<a href="${pageContext.request.contextPath}/showSpCakeCatOrderPDF" target="_blank"><h1>PDF</h1></a>
<!--rightSidebar-->
