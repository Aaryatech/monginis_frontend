...
<c:url var="getSpCakeCatFlavourBySpfId" value="/getSpCakeCatFlavourBySpfId" />
...
<!----------------------------------------Form Start-------------------------------------------------->
<form action="${pageContext.request.contextPath}/orderSpCakeCat"  method="post" class="form-horizontal" name="from_ord" id="validation-form" enctype="multipart/form-data"onsubmit="return validate()">
...
<input type="hidden" name="sp_min_weight" id="sp_min_weight" value="${album.minWt}">
<input type="hidden" name="sp_max_weight" id="sp_max_weight" value="${album.maxWt}">
...
<input type="hidden" name="prevImage" id="prevImage" value="${album.photo1}">
...
<input type="hidden" name="album_code" id="album_code" value="${album.albumCode}">
<input type="hidden" name="album_id" id="album_id" value="${album.albumId}">
<input type="hidden" name="album_name" id="album_name" value="${album.albumName}">
...
$(document).ready(function() { 
	$('#sptype').change(
			function() {
				$.getJSON('${getSpCakeCatFlavourBySpfId}', {
					spType : $(this).val(),
					ajax : 'true'
				}, function(data) {
