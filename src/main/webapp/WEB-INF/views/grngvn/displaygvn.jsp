...
<div class="colOuter">
		<div class="col2full">
        	<input name="" class="buttonsaveorder" value="Search..." type="button" onclick="searchGVN()">
			</div>
</div>
...
<%--  <c:forEach items="${gvnList}" var="gvnList"> 
  <tr>
    ...
    <td><c:out value="${gvnList.grnGvnStatus}"/></td>
     <td><c:out value="${gvnList.gvnPhotoUpload1}"/></td>
      <td><c:out value="${gvnList.gvnPhotoUpload2}"/></td>
