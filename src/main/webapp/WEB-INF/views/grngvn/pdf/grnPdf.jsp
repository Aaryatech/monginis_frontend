	...
	<table class="" cellspacing=0 border=1>
		<tbody>
			...
			<tr style="height: 50px;">
				<td
					style="padding: 10px; font-family: Calibri; text-align: center; font-size: 20px; color: #000000; font-weight: bold; border-left: 1px solid; border-top: 1px solid; border-bottom: 1px solid; border-left-color: #000000; border-top-color: #000000; border-bottom-color: #000000;"
